...
class Alien(Sprite):
    ...
    def __init__(self, ai_settings, screen):
        """Inicializa o alinígena e define sua posição inicial"""
        super(Alien, self).__init__()
        self.screen = screen
        self.ai_settings = ai_settings

        #carrega aimagem do alien e define seu atributo rect
        self.image = pygame.image.load('images/alien.bmp')
        self.rect = self.image.get_rect()

        #inicia cada alienígena próximo à parte superior esquerda da tela
