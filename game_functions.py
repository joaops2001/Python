...
def check_keydown_events(event, ai_settings, screen, sb, stats, aliens, ship, bullets):
    ...
    if event.key == pygame.K_RIGHT:
        ...
        start_game(ai_settings, screen, sb, ship, stats, aliens, bullets)
...
def create_alien(ai_settings, screen, aliens, alien_number, row_number):
    #Cria os ETs tudo e posiciona na linha
...
def check_events(ai_settings, screen, stats, sb, play_button, ship, aliens,
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            check_keydown_events(event, ai_settings, screen, sb, stats, aliens, ship, bullets)
...
def start_game(ai_settings, screen, sb, ship, stats, aliens, bullets):
    #Oculta o cursor
...
def ship_hit(ai_settings, stats, screen, sb, ship, aliens, bullets):
    ...
    if stats.ships_left > 0:
        ...
        #Decrementa o painel de pontuações
        sb.prep_ships()
